...
Try the [statistics-resampling package](https://gnu-octave.github.io/statistics-resampling/) online in a Notebook with an **Octave** kernel within Jupyter Lab using Binder by clicking the launch-binder button:
